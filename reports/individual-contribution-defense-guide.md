...
| 5 | **Patricia Gyan** | 22141938 | DCIT 308 | `HashTable.java`, `CustomSet.java`, `CustomMap.java`, `DisjointSet.java`, `Graph.java` | **Q:** How are collisions handled? **A:** Separate chaining with linked buckets. Rehashes to the next prime number after $2\times$ size (starting from index-derived prime capacity 103 with seed 6802) when load factor exceeds 0.75. **Q:** Path compression? **A:** Flattens tree during `find()`. |
